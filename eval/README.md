...
ఎండలో పడిపోతే ఏం చేయాలి → MRR 0.20, top-1 electricity. Colloquial Telugu ("if you fall down in the sun, what to do"). Zero shared tokens with the heat stroke doc (which says వడదెబ్బ), and the model has seen little colloquial Telugu — it latched onto ఎండ/summer → electricity demand. 